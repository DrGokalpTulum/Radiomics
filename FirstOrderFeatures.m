...
function [f_order_vector]=FirstOrderFeatures (ROIonly,volume_mm)
% ROIonly=ROIonly_wlet_LL;
...
f_order_vector=[enerji, toplam_enerji, entroppy, minimum, Tenthpercentile, Ninethpercentile, maksimum, ortalama, medyan, Interquartile_Range, menzil, mad, rmad, rms, stdev, skewn, kurt ];
